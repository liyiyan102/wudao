...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      opt('f', '没人用过的老歌，从各种角落翻出来的', { digger: 3, groove: 1 }, ['Rare Groove', 'Old School'], ['Groove'], ['挖歌'], ['Digger'], '音乐上你走的是冷门路线——别人挑歌，你是在挖歌。')
    ]
  },
  {
    kind: 'origin',
    ...
    options: [
      opt('a', '认识有意思的人，扩圈子', { socialweaver: 3, nomad: 1 }, [], ['Flow'], ['Party'], ['Connector'], '你最开始跳舞，就是冲着能认识人去的。换个新场子，就是换一批还没加上的微信。'),
  ...
  },
  {
    ...
    options: [
      ...
      opt('h', '我会先跟人打个招呼，顺手把人拽进圈', { socialweaver: 3, resonance: 1 }, [], ['Flow'], ['Party'], ['Connector'], '你在圈里很少只跳自己的：你会先跟人打招呼，再顺手把人拽进圈，场子热起来你最爽。'),
      opt('i', '我会先热身两轮，能跳再进，不能就当观众', { patcher: 3, watcher: 1 }, [], ['Recovery'], ['观赛'], ['Observer'], '你不会硬冲：先热身两轮，能跳再进；不行就当观众，留着身体明天继续。')
    ]
  },
  {
