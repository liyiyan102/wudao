...
const QUESTIONS = [
  ...
  {
    title: '已经到了练舞现场，音乐一响、圈也围起来了，你会变成哪种？',
    options: [
      ...
      opt('f', '先看今天练什么，再决定怎么进入', { wanderer: 2, tactician: 1 }, [], ['Foundation'], ['课堂'], ['Teacher'], '到了现场你还是会先确认今天练什么、有没有主题，再决定怎么进入。'),
      opt('g', '心跳很快，脚在动，人还在圈外', { edgewalker: 3 }, [], ['Freestyle'], ['即兴局'], ['Student'], '圈围起来那一刻，你的心跳先上场了，人还站在圈外。'),
      opt('h', '我先去跟新朋友打个招呼', { socialweaver: 3 }, [], ['Flow'], ['Party'], ['Connector'], '到了现场你会先去认识新面孔——对你来说，跳舞也是最快的破冰方式。'),
      opt('i', '先看看身体今天给不给面子', { patcher: 3 }, [], ['Recovery'], ['观赛'], ['Observer'], '音乐响了你也不会立刻冲，先看看膝盖和身体今天给不给面子。')
    ]
  },
  {
